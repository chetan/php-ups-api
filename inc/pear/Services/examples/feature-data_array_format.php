...
try
{
	/** FEATURE: data array format **/
	// make the call and get the data array
	$response = $request->call();
	$format   = Services_WorkXpress::DATA_ARRAY_FORMAT_FULLY_COLLAPSED;
//	$format   = Services_WorkXpress::DATA_ARRAY_FORMAT_PARTIALLY_COLLAPSED;
//	$format   = Services_WorkXpress::DATA_ARRAY_FORMAT_NOT_COLLAPSED;
	$items    = $response->getDataArray($format);
