...
$request->addField(102, Services_WorkXpress::FIELD_FORMAT_STORED_VALUE);
//$request->addField(102, Services_WorkXpress::FIELD_FORMAT_TEXT_ONLY);
//$request->addField(102, Services_WorkXpress::FIELD_FORMAT_DISPLAYED_VALUE);
